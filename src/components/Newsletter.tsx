  ...
  return (
    <section id="cta" className="mt-10 mb-5 lg:my-20">
      <div className="mx-auto w-full sm:px-6 lg:px-4">
        <div className="relative isolate overflow-hidden bg-[#191919] px-16 py-12 border border-primary">
          ...
          <form className="mx-auto mt-10 flex max-w-md gap-x-4">
            ...
            <div className="flex rounded-full bg-white px-2 py-1">
              <input
                ...
                autoComplete="email"
                className="block w-[250px] px-3 text-md font-[600] bg-transparent text-black placeholder:text-[#BFBFBF] outline-0"
              />
              <div className="flex w-max z-10">
                <button className="bg-secondary text-white text-md font-[500] shadow-[0px_4.5px_0px_0px_black] px-12 py-2.5 rounded-full mb-1" >Subscribe</button>
              </div>
            </div>
          </form>
