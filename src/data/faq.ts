...
export const faqs: IFAQ[] = [
    ...
    },
    {
        ...
        answer: 'No, cover photos created with our free templates and resources will not have any watermarks. However, if you use premium elements, you may need to upgrade to a paid plan to download them without watermarks.',
    },
    {
        question: 'Can someone design a cover for me?',
        answer: 'Yes! If you prefer a professionally designed cover, we offer custom design services where our expert designers can create a unique cover photo tailored to your needs. Contact us for more details.'
    },
    {
        question: 'How frequently are new covers added to the platform?',
        answer: 'We regularly update our template library with fresh and trendy designs. New cover templates are added weekly, ensuring you always have access to the latest styles and trends for your social media branding.'
    }
];